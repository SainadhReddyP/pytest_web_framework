...
class TestRegister(BaseTest):
    def test_register_with_mandatory_fields(self):
        ...
        account_success_pg = register_pg.register_account("Sainadh", "Reddy", "Male", self.generate_email_with_timestamp(),
    ...
    def test_register_with_invalid_phone_number(self):
        home_pg = HomePage(self.driver)
        register_pg = home_pg.click_on_register_button()
        register_pg.register_account("Sainadh", "Reddy", "Male", self.generate_email_with_timestamp(),
                                                          "Python@123", "12345")
